    ...
    static resolveLink(item: GuidResolverResponse): string | undefined {
        ...
        switch (item.type) {
            ...
            case 'Microsoft Entra ID Group Details':
                return `https://portal.azure.com/#view/Microsoft_AAD_IAM/GroupDetailsMenuBlade/~/Overview/groupId/${item.group.guid}/menuId/`;
            ...
            case 'Microsoft Entra ID User Details':
                return `https://portal.azure.com/#view/Microsoft_AAD_UsersAndTenants/UserProfileMenuBlade/~/overview/userId/${item.user.guid}/hidePreviewBanner~/true`;
            default:
